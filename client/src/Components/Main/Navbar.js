                    ...
                    <div className="flex items-center justify-between">
                        <>
                            ...
                            {props.logIn ? (
                                ...
                                <>
                                    <DropDown title="Looking For Blood" children={["Patient Login/Register", "Blood Bank Directory"]} links={["/login/patient", "/bloodDirect"]}></DropDown>
                                    <DropDown title="Want To Donate Blood" children={["Donor Login/Register", "Blood Donation Camps", "About Blood Donation"]} links={["/login/donor", "/bloodCamps", "/aboutBloodDonation"]}></DropDown>
