...
const Auth = (props) => {
    ...
    const signUp = async (e) => {
        ...
        if(pathname === "/register/donor"){
            if(handle !== "black" && (age <18 || age>65)){
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div><label className="font-semibold  leading-8">{auth === 0 ? "Mobile:" : "Username:"}<font color="red">*</font></label>
                                        ...
                                        <h3>
                                            ...
                                            {isError ? <div style={{"display":"inline-block","color":"red"}}><pre>Your Mobile Number is : Invalid</pre></div> : "Your Mobile Number is : +91 " + phone}
                                        </h3>
                                        </div>
                                    {handle == "bank" &&
                                        <div>
